...
export function posterSrc(title: Pick<Tables<'titles'>, 'poster_path' | 'title' | 'year' | 'title_type'>): string {
...
export function backdropSrc(title: Pick<Tables<'titles'>, 'backdrop_path' | 'poster_path' | 'title' | 'year' | 'title_type'>): string {
